      ...
      <section className="skills section" id="skills">
        ...
        {activeTab === 'coding' && (
          <div className='tag_container' data-aos="fade-up">
            ...
            {/* <div className='tag_container_narrow' */}
      {/* data-aos="fade-up"> */}
        <div className="skills__content">
        ...
        {activeTab === 'uiux' && (
          <div className='tag_container_narrow'>
            <div className="skills__content_purple">
              <TagComponent
                tags={["UI Design", "Visual Design", "UX Design", "Testing", "Interaction Design", "Accessability", "Prototyping", "Web/Mobile Design", "Agile Development", "Experience Driven Design", "AR/VR Design", "User Research", "Wireframing", "Human-Centered Design"]}
